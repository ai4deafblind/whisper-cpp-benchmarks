...
def write_summary(
    ...
    summary: dict = {
        "config": {
            ...
            "suppress_non_speech": config.whisper.suppress_non_speech,
            "no_speech_threshold": config.whisper.no_speech_threshold,
            "vad_enabled": config.whisper.vad_enabled,
            "vad_model_path": str(config.whisper.vad_model_path) if config.whisper.vad_model_path else None,
            "vad_threshold": config.whisper.vad_threshold,
            "vad_min_speech_duration_ms": config.whisper.vad_min_speech_duration_ms,
            "vad_min_silence_duration_ms": config.whisper.vad_min_silence_duration_ms,
            "vad_max_speech_duration_s": config.whisper.vad_max_speech_duration_s,
            "vad_speech_pad_ms": config.whisper.vad_speech_pad_ms,
            "vad_samples_overlap": config.whisper.vad_samples_overlap,
